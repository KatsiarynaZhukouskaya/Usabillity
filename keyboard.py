...
from models import January, February, March, April, May, \
...
HOROSCOPE = InlineKeyboardMarkup().add(BTN_HOROSCOPE_TODAY).add(BTN_HOROSCOPE_TOMORROW)\
                                    .add(BTN_HOROSCOPE_WEEK).add(BTN_HOROSCOPE_MONTH)
...
ZODIAC = InlineKeyboardMarkup(row_width=2).add(BTN_HOROSCOPE_ARIES, BTN_HOROSCOPE_TAURUS)\
                                        .add(BTN_HOROSCOPE_GEMINI, BTN_HOROSCOPE_CANCER)\
                                        .add(BTN_HOROSCOPE_LEO, BTN_HOROSCOPE_VIRGO)\
                                        .add(BTN_HOROSCOPE_LIBRA, BTN_HOROSCOPE_SCORPIO)\
                                        .add(BTN_HOROSCOPE_SAGITARIUS, BTN_HOROSCOPE_CAPRICORN)\
                                        .add(BTN_HOROSCOPE_AQUARIUS, BTN_HOROSCOPE_PISCES)
